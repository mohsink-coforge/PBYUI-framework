...
test('Add new vehicle', async ({ page }) => {
 ...
 // await page.getByRole('textbox', { name: 'Enter Vehicle Identification' }
  await page.locator('div:nth-child(2) > div:nth-child(2) > .ng-untouched > .select-form-field > .mat-mdc-form-field > .mat-mdc-text-field-wrapper > .mat-mdc-form-field-flex > .mat-mdc-form-field-icon-suffix > .mat-icon').click();
